...
func getDateStringFromDate(date : Date) -> String
{
    ...
    //dateFormatter.timeZone = TimeZone(abbreviation: "GMT") //Set timezone that you want
    dateFormatter.locale = NSLocale.current
    dateFormatter.dateFormat = DATE_FORMAT.DISPLAY_DATE_FORMAT1
    return dateFormatter.string(from: date)
}

func getDateStringFromDate1(date : Date) -> String
{
    let dateFormatter = DateFormatter()
    //dateFormatter.timeZone = TimeZone(abbreviation: "GMT") //Set timezone that you want
    dateFormatter.locale = NSLocale.current
    dateFormatter.dateFormat = DATE_FORMAT.DISPLAY_DATE_FORMAT2
    return dateFormatter.string(from: date)
}
...
func getdayDifferenceFromCurrentDay(_ date : Date) -> String
{
    let calendar = NSCalendar.current
    let date1 = date
    let date2 = calendar.startOfDay(for: getCurrentDate())
    ...
    {
        timeAgo = getDateStringFromDate1(date: date)
    }
